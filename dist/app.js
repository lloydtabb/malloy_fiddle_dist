<!--googleoff: all-->
<html lang="en"><head><title>crswenson.users.x20web.corp.google.com - Google Single Sign On: Sign into corp</title>
<link href="/c/login.css" rel="stylesheet" />
<link rel="icon" href="/c/favicon.ico" type="image/x-icon" />
<script type="text/javascript" src="/c/corploginscript.js" nonce="dubtaWg6ht_W6YcJL1jZ2Q">
        
      </script>
<script type="text/javascript" nonce="dubtaWg6ht_W6YcJL1jZ2Q">
...
<tr><td nowrap="nowrap"><table width="100%" align="center" cellpadding="0" cellspacing="0" bgcolor="#C3D9FF" style="margin-bottom:5" role="presentation"><tr><td class="bubble tl"><img src="/c/tl.gif" alt="" /></td>
...
<div role="main"><form method="post" id="loginForm" name="loginForm" action="/login"><input type="hidden" id="s" name="s" value="crswenson.users.x20web.corp.google.com:443/uberproxy/"/>
<input type="hidden" id="d" name="d" value="https://crswenson.users.x20web.corp.google.com/www/app.js?upxsrf=AO9zFu1zanDabaWwNHRLdfHYyv0pNxyEHafZCmKOxFvmNbsiZQ:1668038148349"/>
<input type="hidden" id="keyIds" name="keyIds" value="p2T,ul2,3aq,r4j"/>
...
<table width="1" align="center" cellpadding="5" cellspacing="1" class="signin" role="presentation"><tr><td width="25%" valign="top" style="padding-top: .5em; padding-right: 2em;"><table cellpadding="5" width="100%" border="0" role="presentation"><tr><td colspan="2" style="text-align:center" nowrap="nowrap"><div class="caption"><h1>Use your SSO username and password</h1></div>
...
<td nowrap="nowrap"><input type="text" name="u" tabindex="1" size="15" id="username" aria-required="aria-required" value="" />
<span style="font-size: 83%; position: relative; bottom: 2px;"><span style="padding: 0 3px 0 5px;">@</span>
google.com
<a href="#" id="roleToggle" style="color:black; text-decoration: none" role="button" aria-expanded="aria-expanded" aria-label="Expand to show role account input">[+]</a>
<script type="text/javascript" nonce="dubtaWg6ht_W6YcJL1jZ2Q">
...
<td nowrap="nowrap"><input type="password" name="pw" tabindex="3" size="15" autocomplete="off" id="password" aria-required="aria-required" /></td></tr>
...
<td nowrap="nowrap"><input type="text" name="otp" tabindex="4" size="15" autocomplete="off" id="otp" aria-required="aria-required" />
</td></tr>
...
<td class="image-cell" valign="top"><div id="corplogin-image"><img class="login-image" src="https://static.corp.google.com/corpsso/images/IMG_0773.jpg" width="400" height="300" alt="" /></div></td></tr></table></form></div>
...
<td width="1%"><a id="gnubbyLinkFooter" href="https://login.corp.google.com/request?s=crswenson.users.x20web.corp.google.com:443/uberproxy/&amp;d=https://crswenson.users.x20web.corp.google.com/www/app.js?upxsrf%3DAO9zFu1zanDabaWwNHRLdfHYyv0pNxyEHafZCmKOxFvmNbsiZQ:1668038148349&amp;maxAge=1200&amp;authLevel=2000000&amp;keyIds=p2T,ul2,3aq,r4j"><img src="/c/balls.gif" border="0" alt="Sign in using Security Key" align="left" vspace="13" /></a>
<script type="text/javascript" nonce="dubtaWg6ht_W6YcJL1jZ2Q">
